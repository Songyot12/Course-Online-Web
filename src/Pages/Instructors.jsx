...
const Instructors = () => {
  const mockInstructors = [
    { id: 1, name: 'อ.สมชาย สายไฟ', expert: 'Full-Stack Developer', bio: 'ประสบการณ์พัฒนาเว็บมากกว่า 10 ปี อดีตวิศวกรซอฟต์แวร์ที่บริษัทสตาร์ทอัปชื่อดัง' },
    { id: 2, name: 'ดร.ปัญญาวัฒ เจสัน', expert: 'Data Scientist', bio: 'ผู้เชี่ยวชาญด้านปัญญาประดิษฐ์และการวิเคราะห์ข้อมูล จบการศึกษาจากมหาวิทยาลัยชั้นนำ' }
  ]
